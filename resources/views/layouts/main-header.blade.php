				...
				<div class="container-fluid">
					<div class="main-header-left ">
						...
						<div class="main-header-center mr-3 d-sm-none d-md-none d-lg-block">
							<input class="form-control" placeholder="ابحث عن اى شىء...." type="search"> <button class="btn"><i class="fas fa-search d-none d-md-block"></i></button>
						</div>
					</div>
					<div class="main-header-right">
						...
						<div class="nav nav-item  navbar-nav-right ml-auto">
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{ asset('assets/img') ."/". auth()->user()->avatar;}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{ asset('assets/img') ."/". auth()->user()->avatar;}}" class=""></div>
											<div class="mr-3 my-auto">
												<h6>{{ auth()->user()->name; }}</h6><span>{{ auth()->user()->email; }}</span>
											</div>
										</div>
									</div>
									<a class="dropdown-item" href="{{ url('/' . $page='profile') }}"><i class="bx bx-user-circle"></i>Profile</a>
									<a class="dropdown-item" href="{{ url('/' . $page='editprofile') }}"><i class="bx bx-cog"></i> Edit Profile</a>
